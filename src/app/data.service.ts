...
export class DataService {
  ...
  loadProjects(){
    var p1 = new Project(1, "November 2021","NASA Space App Challenge", "A website the informs about the suns impact on us on earth and the different satellites that orbit the sun.",
     "link", "VB1.png", "hej", "hej", "Figma, HTML/CSS/JS");
    var p2 = new Project(2, "November 2021", "Website for VB-ost", "A clickable HiFi prototype of a website for Västerbottensost. Developed in collaboration with Västerbottensost during a course at Umeå University.",
